...
Usage:
    ...
    python -m agentic_author_ai.demo_writer --prompt "Write a 2-page paper on agentic AI for finance" --session "Lseg Notes"
...
from .planner import Planner  # alias to Router
...
def main():
    ...
    # Planner orchestrates; using Router alias to keep naming consistent in logs if you extend tracing
